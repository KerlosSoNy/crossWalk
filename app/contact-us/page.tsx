...
export const metadata: Metadata = {
    metadataBase: new URL("https://cross-walk.vercel.app/contact-us"),
    title: {
        default: "CrossWalk",
        template:
            "%s | Contact Us - CrossWalk",
    },
    description:
...
export default function Page() {
    return (
        <>
            <div className='relative flex flex-col items-center justify-center pt-[300px]'>
                <div className='absolute -top-32 left-0 w-full !h-[500px] z-[-1] overflow-hidden'>
                    <Image
                        width={1000}
                        height={1000}
                        alt='Contact-us'
                    ...
                    />
                    <div className='absolute -top-32 left-0 w-full !h-[2000px] z-[10] bg-black/50' />
                </div>
                <div className='flex flex-col items-center justify-center gap-8 mb-16 -mt-52 text-center'>
                    <h1 className="font-manrope text-white text-4xl font-bold w-[80%] md:w-[65%] leading-[50px]"> We use an agile approach to test assumptions and connect with the needs of your audience early and often.</h1>
                </div>
                <Cards />
                <div className="flex flex-col justify-center items-center container mx-auto my-10">
                    <div className="grid lg:grid-cols-2 grid-cols-1 container mx-auto ps-20">
                        <div className="lg:mb-0 mb-10">
                            <div className="group w-[80%] h-full">
                                <div className="relative h-full">
                                    <h1 className="font-manrope text-black text-4xl font-bold leading-10 absolute top-11 left-11">Send Us a Message
                                    </h1>
                                    <h1 className="font-manrope text-black text-4xl font-bold leading-10 absolute top-24 left-11">Now.
                                    </h1>
